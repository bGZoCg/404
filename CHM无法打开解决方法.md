转自：http://www.yaosansi.com/post/cannot_open_chm_file.html
...
![img](http://www.yaosansi.com/upload/2008/3/openChmFileAlert.gif)
3、打开后，内容区就显示正常了！以后直接双击该CHM文件，就可以正常显示了！

**二、出现空白页面或该页无法显示的错误**
**解决办法**：右键单击CHM文件的，选择“属性”，发现“常规”栏下多出几行字：“安全：此文件来自其他计算机，可能被阻止以帮助保护计算机”点击旁边的“解除锁定”即可解决
...
![img](http://www.yaosansi.com/upload/2008/3/UnlockChmFile.gif)

**五、在英文操作系统下无法打开
**解决办法：解压缩以后，必须放在英文路径下，并且把chm文件本身也改用英文命名
